...
<div align="center">
  ...
  <p>Please note that this project is currently in development, so bugs and crashes may occur. If you encounter any issues report them in our group or create an <a href="https://github.com/Eduardob3677/WaEnhancer/issues">issue</a> here.</p>
</div>
...
2. Install the Xposed Framework (recommend [this](https://github.com/JingMatrix/LSPosed) LPosed) on
   your device.
3. Download the WaEnhancer from the [Releases](https://github.com/Eduardob3677/WaEnhancer/releases) section.
